#ifndef CHROMOFROMFILE8_H
#define CHROMOFROMFILE8_H
...
class ChromoFromFile8 : public Test
{
    public:
        Simulation *sim;
        CPGNet *net;
        ...
        ChromoFromFile8() 
        { 
            char filename[] = "../../../log/chromosomes/8-chromosome.txt";
