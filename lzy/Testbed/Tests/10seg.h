#ifndef CHROMOFROMFILE10_H
#define CHROMOFROMFILE10_H
...
class ChromoFromFile10 : public Test
{
    public:
        Simulation *sim;
        CPGNet *net;
        ...
        ChromoFromFile10() 
        { 
            char filename[] = "../../../log/chromosomes/10-chromosome.txt";
