#ifndef CHROMOFROMFILE4_H
#define CHROMOFROMFILE4_H
...
class ChromoFromFile4 : public Test
{
    public:
        Simulation *sim;
        CPGNet *net;
        ...
        ChromoFromFile4() 
        { 
            char filename[] = "../../../log/chromosomes/4-chromosome.txt";
